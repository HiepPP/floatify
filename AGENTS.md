...
This project is indexed by GitNexus as **floatify** (421 symbols, 701 relationships, 2 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
