...
This project is indexed by GitNexus as **floatify** (253 symbols, 316 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
